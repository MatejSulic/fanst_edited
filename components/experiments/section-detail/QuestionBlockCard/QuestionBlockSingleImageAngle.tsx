...
const LockedQuestionBlockSingleImageAngle = ({
  question,
}: QuestionBlockSpecificCardSharedProps) => {
  return (
    <Box
...
const UnlockedQuestionBlockSingleImageAngle = ({
  question,
}: QuestionBlockSpecificCardSharedProps) => {
...
const QuestionBlockSingleImageAngle = ({
  question,
  locked,
}: QuestionBlockCardSharedProps) => {
  return locked ? (
    <LockedQuestionBlockSingleImageAngle question={question} />
  ) : (
    <UnlockedQuestionBlockSingleImageAngle question={question} />
  );
};

export default QuestionBlockSingleImageAngle;
